...
$(document).ready(function() {
    ...
    $("#mobile-collapse").on("click", function() { if (c > 991) { $(".pcoded-navbar:not(.theme-horizontal)").toggleClass("navbar-collapsed") } });
    $(".mob-toggler").on("click", function() { $(".pcoded-header > .collapse,.pcoded-header > .container > .collapse").toggleClass("d-flex") });
    $(".search-btn").on("click", function() {
        var d = $(this);
        $(".main-search").addClass("open");
        if (c <= 991) { $(".main-search .form-control").css({ width: "90px" }) } else { $(".main-search .form-control").css({ width: "150px" }) }
    });
    ...
    $(".search-bar .close").on("click", function() { $(".search-bar").slideToggle("fast") });
    if (c <= 991) {
        $(".main-search").addClass("open");
        $(".main-search .form-control").css({ width: "100px" })
    }
    if ($(".noti-body")[0]) { var b = new PerfectScrollbar(".notification  .noti-body", { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40, }) }
    if (!$(".pcoded-navbar").hasClass("theme-horizontal")) { var c = $(window)[0].innerWidth; if ($(".navbar-content")[0]) { if (c < 992 || $(".pcoded-navbar").hasClass("menupos-static")) { var b = new PerfectScrollbar(".navbar-content", { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40, }) } else { var b = new PerfectScrollbar(".navbar-content", { wheelSpeed: 0.5, swipeEasing: 0, suppressScrollX: !0, wheelPropagation: 1, minScrollbarLength: 40, }) } } }
    $(".card-option .close-card").on("click", function() {
        ...
        setTimeout(function() { d.parents(".card").remove() }, 1500)
    });
    ...
    $(".card-option .minimize-card").on("click", function() {
        ...
        if (!d.hasClass("full-card")) { $(d).css("height", "auto") }
    ...
    $(".card-option .full-card").on("click", function() {
        ...
        if (e.hasClass("full-card")) {
            ...
            $("body").css("overflow", "");
            e.removeAttr("style");
            setTimeout(function() { $("html,body").animate({ scrollTop: ($(e).offset().top) - 70 }, 500) }, 400)
        }
    });
    ...
    $(".form-control").each(function() { a($(this)) });
    $(".form-control").on("blur", function() { a($(this)) });
    $(".form-control").on("focus", function() { $(this).parent(".form-group").addClass("fill") });

    function a(f) { var g = 0; try { g = f.attr("placeholder").length } catch (d) { g = 0 } if (f.val().length > 0 || g > 0) { f.parent(".form-group").addClass("fill") } else { f.parent(".form-group").removeClass("fill") } }
...
$.ripple(".btn, .pcoded-navbar a,.pcoded-header .navbar-nav > li > .dropdown > a,.page-link, .nav .nav-link", { debug: false, on: "mousedown", opacity: 0.4, color: "auto", multi: false, duration: 0.7, rate: function(a) { return a }, easing: "linear" });
