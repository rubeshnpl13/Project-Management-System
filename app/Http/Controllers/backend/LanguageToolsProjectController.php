...
use App\Models\backend\LanguageToolsProject;
use Illuminate\Http\Request;

use App\Http\Controllers\backend\BackendBaseController;

class LanguageToolsProjectController extends BackendBaseController
{
    protected $base_route = 'backend.language_tools_project.';
    protected $base_view = 'backend.language_tools_project.';
    protected $module = 'Language Tool Project';
    public function __construct()
    {
        $this->model= new LanguageToolsProject();
    }
