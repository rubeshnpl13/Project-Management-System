...
use App\Models\Backend\StudentProject;

class Student_ProjectController extends BackendBaseController
{
    protected $base_route = 'backend.student_project.';
    protected $base_view = 'backend.student_project.';
    protected $module = 'StudentProject';
    public function __construct()
    {
        $this->model= new StudentProject();
    }
