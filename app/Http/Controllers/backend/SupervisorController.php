...
class SupervisorController extends BackendBaseController
{
    protected $base_route = 'backend.supervisor.';
    protected $base_view = 'backend.supervisor.';
    protected $module = 'Supervisor';
    ...
    {
        $data['supervisor_types']= SupervisorType::pluck('title','id');
