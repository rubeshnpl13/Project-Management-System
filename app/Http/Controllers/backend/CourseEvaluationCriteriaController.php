...
use App\Models\Backend\EvaluationCriteria;
use App\Models\Backend\CourseEvaluationCriteria;
use Illuminate\Http\Request;

class CourseEvaluationCriteriaController extends BackendBaseController
{
    protected $base_route = 'backend.course_evaluation_criteria.';
    protected $base_view = 'backend.course_evaluation_criteria.';
    protected $module = 'CourseEvaluationCriteria';
    public function __construct()
    {
        $this->model= new CourseEvaluationCriteria();
    }
    ...
    public function create()
    {
        ...
        $data['evaluation_criterias']= EvaluationCriteria::pluck('title','id');
