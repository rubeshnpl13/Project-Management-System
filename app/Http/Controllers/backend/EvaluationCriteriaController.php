...
class EvaluationCriteriaController extends BackendBaseController
{
    protected $base_route = 'backend.evaluation_criteria.';
    protected $base_view = 'backend.evaluation_criteria.';
    protected $module = 'EvaluationCriteria';
    public function __construct()
    {
        $this->model= new EvaluationCriteria();
    }
    ...
    public function store(Request $request)
    {
        try{
            $request->validate(array(
                'title'=>'required',
                'marks_percentage_cover'=>'required'
            ));
