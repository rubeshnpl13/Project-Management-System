...
class OrganizationController extends BackendBaseController
{
    protected $base_route = 'backend.organizations.';
    protected $base_view = 'backend.organizations.';
    protected $module = 'Organization';
