...
use App\Models\Backend\Project_Tool;
use App\Models\Backend\LanguageTools;
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;

class ProjectToolController extends BackendBaseController
{
    protected $base_route = 'backend.project_tool.';
    protected $base_view = 'backend.project_tool.';
    protected $module = 'ProjectTool';
    public function __construct()
    {
        $this->model= new Project_Tool();
    }
    ...
    public function create()
    {
        ...
        $data['language_tool']= LanguageTools::pluck('title','id');
